...
const Banner = () => {
  return (
    <div className='w-full h-[70vh] relative py-24'>
        <img 
            src = {bannerImg}
        ...
        <div className='max-w-[95vw] m-auto relative z-10 py-4'>
            <div className='flex flex-col items-center justify-center h-full gap-4'>
                <h1 className='text-[96px] font-serif font-Playfair font-semibold py-4'>
                    <span className='text-[#FA4616]'>Uni </span>
                    <span className='text-[#0021A5]'>Bazaar</span>
                </h1>
                <p className='text-[32px] text-[#D9D9D9] font-Raleway py-4'>Connecting students for buying/selling</p>
                ...
                <button 
                    ...
                    onClick={() => {/* need to keep the functionality of mic click */}}
                >
